...
public class DBUtil {
	...
	static {
		credentialDBMap.put("162208", "ay123");
		bankDBMap.put(
				"162208",
				new Customer("162208", "Utkarsh Dwivedi", LocalDate.of(1996,
						Month.MAY, 24), "Saving", 15500.0F, 200000.0));
		credentialDBMap.put("160662", "di123");
		bankDBMap.put("160662", new Customer("160662", "nesh andi",
